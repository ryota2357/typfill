<script lang="ts">
  ...
  import MarkupTextarea from "./MarkupTextarea.svelte";
...
<div class="space-y-6">
  ...
  <TimelineForm label="学歴" items={data.学歴} />
  <TimelineForm label="職歴" items={data.職歴} />
  <TimelineForm label="免許・資格" items={data.免許・資格} />
